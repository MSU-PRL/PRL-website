...
### File listing:
* **PRL-about-page-timeline-jQuery-compiled.scss**: The file includes all the package's core CSS files in one location. Do not make any modifications to this file. The **prlCustomCSS-2018.scss** file (see CSS folder section) is setup to automatically include the contents of this file so all PRL custom CSS is uploaded to Mura from one location.
* **PRL-about-page-history-timeline.html**: This file houses the timeline content. It also includes the core timeline JS scripts. To modify timeline content, make the changes to this file in a viable code editor, such as <a href="https://code.visualstudio.com/"> Visual Studio Code</a>, then paste the code into the **PRL-about-page.html** file, found under the HTML folder in this repository.
