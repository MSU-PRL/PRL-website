...
## CSS Folder
### How to modify CSS:
*This section applies **only** to the three files, prlCustomCSS-2020.scss, prlCustomCSS-2020.css, and prlCustomCSS-2020.min.css. Ignore all files related to the jQuery timeline.* 
 * **Custom styles are written in the prlCustomCSS-2020.scss file**. This is the core styles file, written in SCSS. SCSS allows for consistent visual components.
