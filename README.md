...
### File listing:
* **PRLtimelinejQuerycompiled.scss**: The file includes all the package's core CSS files in one location. The **prlCustomCSS-2018.scss** file (see CSS folder section above) is setup to automatically include the contents of this file, as it is the main PRL custom CSS file. Do not make any modifications to this code.
