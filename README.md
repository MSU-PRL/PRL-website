...
<ul>
 ...
 <p> <strong>Any CSS changes to the timeline should be made in the 'prlCustomCSS-2018.scss' file in its relevant 'About' section</strong>. Do not make changes to the "PRLtimelinejQuerycompiled.scss" file. As the timeline is constantly updated by the developer, core files will have to be overwritten. We would lose any custom changes if we make them in those core files.</p>
